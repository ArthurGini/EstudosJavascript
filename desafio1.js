...
function filme(personagens, filmes, lancamentos, id)
{
    if (id > 3){
        ...
        return console.log("Leia é um personagem do filme Star wars que estreou no cinema em 1977.")
    }
    else{
        return console.log(personagens[id]+" é um personagem do filme "+ filmes[id]+" que estreou no cinema em " +lancamentos[id] + ".")
