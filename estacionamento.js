...
function calcularValorDevido(placa){
   // Seu código vem aqui...
   var pagamento = 0
   entradas  = calcularNumeroDeEntradas(placa)
   if (entradas <= 20 ){
        //10 reais por entrada
        pagamento = entradas*10
        //console.log("caso 1:" +pagamento)
   }
   else if (entradas >= 21){
        //10 reais as primeiras 20 entradas mais 5 reais cada
        pagamento = entradas*10
        pagamento = pagamento-200
        pagamento = 5*entradas
        //console.log('caso 2:'+pagamento)
   }
   
   return pagamento
}
//var enter = 'AKX-3333'
//console.log(calcularNumeroDeEntradas(enter))
//console.log(calcularValorDevido(enter))
